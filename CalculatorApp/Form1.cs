...
namespace CalculatorApp
{
    public partial class Calculator : Form
    {
        ...
        private Rectangle deleteButtonOriginalRectangle;
        ...
        private void Calculator_Load(object sender, EventArgs e)
        {
            ...
            deleteButtonOriginalRectangle = new Rectangle(deleteButton.Location.X, deleteButton.Location.Y, deleteButton.Width, deleteButton.Height);
        ...
        private void Calculator_Resize(object sender, EventArgs e)
        {
            ...
            resizeControl(deleteButtonOriginalRectangle, deleteButton);
